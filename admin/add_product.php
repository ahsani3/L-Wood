					...
					<form method="post" action="">
						<div class="card-add-product">
								...
								<div class="col-md-10">
									<div class="d-flex" style="flex-wrap: wrap;">
										<div class="contain-label-img">
											...
											<div class="opsi-label-img" onclick="removeImg('imgMain','main-image')">
											...
											<input type="file" name="gambar_utama" class="d-none" id="main-image" accept="image/*" onchange="preview(this,'imgMain')" required>
										</div>
										...
										<div class="contain-label-img">
											...
											<div class="opsi-label-img" onclick="removeImg('img<?= $i; ?>','image<?= $i ?>')">
												<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M18.8892 9.55408C18.8892 17.5731 20.0435 21.1979 12.2797 21.1979C4.5149 21.1979 5.693 17.5731 5.693 9.55408" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M20.3652 6.47979H4.21472" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M15.7149 6.47979C15.7149 6.47979 16.2435 2.71408 12.2892 2.71408C8.3359 2.71408 8.86447 6.47979 8.86447 6.47979" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
											...
											<input type="file" name="gambar_utama" class="d-none" id="image<?= $i ?>" accept="image/*" onchange="preview(this,'img<?= $i; ?>')">
										</div>
										<?php endfor ?>
									</div>
										...
										<div class="contain-label-img">
											<label class="mb-8" for="main-video">
												<div class="label-img">
													...
													<video id="videoMain" class="output-img"></video>
												</div>
											</label>
											...
											<input type="file" name="gambar_utama" class="d-none" id="main-video" accept="video/*" onchange="preview(this,'videoMain')">
										</div>
							...
							<div class="row mb-24">
								...
								<div class="col-md-10">
									<div class="contain-input">
										<select class="input-custome" style="outline: none;">
								...
								<div class="col-md-10">
									<div class="row">
										<div class="col-md-4 mb-16">
											<div class="contain-input">
												<input type="number" min="0" name="nama" class="input-custome p3 text-color" placeholder="L">
												<p class="p4 text-information paragraph-color m-0" style="border-left: 1.5px solid var(--line-color);">cm</p>
											</div>
										</div>
										<div class="col-md-4 mb-16">
											<div class="contain-input">
												<input type="number" min="0" name="nama" class="input-custome p3 text-color" placeholder="P">
												<p class="p4 text-information paragraph-color m-0" style="border-left: 1.5px solid var(--line-color);">cm</p>
											</div>
										</div>
										<div class="col-md-4 mb-16">
											<div class="contain-input">
												<input type="number" min="0" name="nama" class="input-custome p3 text-color" placeholder="T">
												<p class="p4 text-information paragraph-color m-0" style="border-left: 1.5px solid var(--line-color);">cm</p>
											</div>
										</div>
									</div>
						...
						<div class="contain-btn-add mb-32">
							<button type="submit" name="tambah" class="btn-custome btn-main">Tambah Produk</button>
						</div>
					</form>
				</div>
